...
/***/ "./src/mainProcess/createDocument.ts":
/*!*******************************************!*\
  !*** ./src/mainProcess/createDocument.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports) {
...
exports.__esModule = true;
exports.createDocumentReturnWidth = void 0;
var createDocumentReturnWidth = function createDocumentReturnWidth(width, height) {
  var doc = app.documents.add(DocumentColorSpace.CMYK, width, height);
  return doc.width;
};
exports.createDocumentReturnWidth = createDocumentReturnWidth;
...
Result._beforeFunc = null;
Result._doBefore = false;
Result._doAfter = false;
Result._afterFunc = null;
;
